...
// The script is for generating a graph with tunable transformation rules and weighted random
public class GraphGenerator : MonoBehaviour
{
    ...
    public class InputGraph
    {
        ...
        // # For an input graph of a rule: the node's relationships can only be linear 
