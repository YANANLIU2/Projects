...
public class Graph
{
    ...
    // Constants
    private const string kOutgoingStr = "Outgoing: \n";
    private const string kIncomingStr = "\nIncoming: \n";
    private const string kCanAccessStr = " can access: ";
    private const string kCanBeAccessedStr = " can be accessed from: ";
    private const string kCommaStr = ", ";
    private const string kLineStr = "\n";
    ...
    public void Splice(uint[] destNodes, GraphGenerator.TransformationRule rule)
    {
