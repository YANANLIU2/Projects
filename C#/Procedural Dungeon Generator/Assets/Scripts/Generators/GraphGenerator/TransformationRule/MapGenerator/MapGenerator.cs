...
public class MapGenerator : MonoBehaviour
{
    ...
    private readonly Vector3 kCenterOffset = new Vector3(0.5f, 0.5f, 0);
    ...
    private void AddAConnection(Vector3Int nodeA, Vector3Int nodeB)
    {
        ...
        DrawALine(nodeA * kTileSpace + kCenterOffset, nodeB * kTileSpace + kCenterOffset, m_connectionPrefab);
    }
    ...
    private void DrawANode(uint id, Vector3Int pos)
    {
        ...
        TilemapManager.Instance.SetTile(displayPos, m_iconDataDict[type]);
    ...
    Vector3Int GetANeighborPos(Vector3Int pos)
    {
        ...
        for (int i = start; i < end; i++)
        {
            ...
            if(TilemapManager.Instance[0].GetTile(neighbor * kTileSpace) == null)
            {
                return neighbor;
            }
        }
